...
func (c *aaaServiceClient) Active(ctx context.Context, in *flatbuffers.Builder,
	...
	err := grpc.Invoke(ctx, "/goums.terminal.AaaService/Active", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aaaServiceClient) Import(ctx context.Context, in *flatbuffers.Builder,
	opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := grpc.Invoke(ctx, "/goums.terminal.AaaService/Import", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AaaService_Active_Handler(srv interface{}, ctx context.Context,
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goums.terminal.AaaService/Active",
	}
...
func _AaaService_Import_Handler(srv interface{}, ctx context.Context,
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goums.terminal.AaaService/Import",
	}
...
var _AaaService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "goums.terminal.AaaService",
